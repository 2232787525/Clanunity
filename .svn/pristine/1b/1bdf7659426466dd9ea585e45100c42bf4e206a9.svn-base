...
@property (nonatomic , copy, nullable) callBackBlock callBack;
// 每次选择图片的最小数, 默认与最大数是9
@property (nonatomic , assign) NSInteger maxCount;
// 记录选中的值
@property (strong,nonatomic,nullable) NSArray *selectPickers;
// 置顶展示图片
...
// @function
// 展示控制器
- (void)showPickerVc:(UIViewController *  _Nonnull)vc;
