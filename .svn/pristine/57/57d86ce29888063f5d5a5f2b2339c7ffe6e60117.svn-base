...
#pragma mark - 获取对应的Session的最新的自己发送的商品气泡
/**
...
#pragma mark - 在|databaseMessageQueue|执行查询操作，获取DB中
/**
...
#pragma mark - 在|databaseMessageQueue|执行查询操作，分页获取聊天记录
...
#pragma mark - 批量插入message，需要用户必须在线，避免插入离线时阅读的消息
/**
