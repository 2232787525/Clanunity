...
{
    NSLog(@"%@",self.photos);
//    [PLGlobalClass imgTapClicked:0 imageArr:self.photos ];
...
//    ZXImage *img = [[ZXImage alloc]initWithURL:curImage.videoURL];
//    
...
-(void)saveImage
{
    ...
    [imageview sd_setImageWithURL:curImage.videoURL];
