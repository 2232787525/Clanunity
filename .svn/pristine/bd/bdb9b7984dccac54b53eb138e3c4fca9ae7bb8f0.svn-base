...
@class RecordingView;
@class Photo;
@interface ChattingMainViewController : ChatBaseSuperVC<UITextViewDelegate, JSMessageInputViewDelegate,UITableViewDataSource,UITableViewDelegate,RecordingDelegate,UIScrollViewDelegate,UIGestureRecognizerDelegate,UIAlertViewDelegate,DDEmotionsViewControllerDelegate,UINavigationControllerDelegate,TTTAttributedLabelDelegate,LCActionSheetDelegate>{
