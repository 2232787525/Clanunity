...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint16_t seqNo)
    {
        ...
        [readAck setMsgId:(UInt32)[object[1] integerValue]];
        SessionType type =SessionTypeSessionTypeSingle;
        if ([object[2] integerValue] == 2) {
            type = SessionTypeSessionTypeGroup;
        }
        [readAck setSessionType:type];
