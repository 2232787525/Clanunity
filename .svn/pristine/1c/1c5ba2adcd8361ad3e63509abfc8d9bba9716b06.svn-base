...
- (id)init
{
    ...
    if (self)
    {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(n_receiveReachabilityChangedNotification:) name:kDDReachabilityChangedNotification object:nil];
    }
    return self;
}
