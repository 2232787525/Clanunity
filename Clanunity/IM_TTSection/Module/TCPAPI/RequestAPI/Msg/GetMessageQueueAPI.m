...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint16_t seqNo)
    {
        ...
        [getMsgListReq setMsgIdBegin:(UInt32)[array[0] intValue]];
        [getMsgListReq setUserId:0];
        [getMsgListReq setMsgCnt:(UInt32)[array[1] integerValue]];
        [getMsgListReq setSessionType: (UInt32)[array[2] integerValue]];
