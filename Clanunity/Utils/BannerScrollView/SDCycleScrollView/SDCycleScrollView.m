...
- (void)initialization
{
    ...
    _bannerBackImageContentMode = UIViewContentModeScaleAspectFill;
...
- (void)setPlaceholderImage:(UIImage *)placeholderImage
{
    ...
    if (!self.backgroundImageView) {
        ...
        bgImageView.contentMode = self.bannerBackImageContentMode;
...
- (int)currentIndex
{
    if (_mainView.width_sd == 0 || _mainView.height_sd == 0) {
        return 0;
    }
...
- (void)layoutSubviews
{
    ...
    CGFloat x = (self.width_sd - size.width) * 0.5;
    if (self.pageControlAliment == SDCycleScrollViewPageContolAlimentRight) {
        x = self.mainView.width_sd - size.width - 10;
    }
    CGFloat y = self.mainView.height_sd - size.height - 10;
